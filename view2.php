...
<script>
  ...
  <input type="submit" style="margin:20px;background-color:#e1a793;" value="FIND RESULTS"><span ><a href="view2.php"><button style="background-color:green;">View All</button></a></span>
</form>
...
if (!$conn) {
  ...
  $sql = "SELECT * FROM petty_cash WHERE date ORDER BY date DESC";
...
document.getElementById("exportButton").addEventListener("click", function() {
  ...
  // Export the workbook to an ArrayBuffer
  ...
  a.href = url;
  a.download = `petty_cash ${currentDateTime}.xlsx`;
  a.click();
...
//   const a = document.createElement("a");
//   a.href = url;
//   a.download = `petty_cash_${currentDateTime}.xlsx`;
//   a.click();
//   URL.revokeObjectURL(url);
// });
</script>
